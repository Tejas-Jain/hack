...
def load_saved_artifacts():
    ...
    with open("./artifacts/rfc_model_diagnosis1.pickle",'rb') as f:
        __model1 = pickle.load(f)

    with open("./artifacts/rfc_model_treatment1.pickle",'rb') as f:
...
if __name__=='__main__':
    ...
    print(predict_disease('no serious illness','shows pericarditis with myocarditis',30,1,0,130,80,100,220,0,1,1,0,0))
    print(predict_disease('no serious illness','25% - 45% dilation of the infrarenal aorta',65,1,1,130,80,100,220,0,1,1,0,1))
    print(predict_disease('no serious illness','none',50,1,1,155,105,100,210,0,1,1,0,0))
    print(predict_disease('mitral valve replacement surgery','none',65,1,1,130,80,110,215,0,1,1,0,0))
    print(predict_disease('no serious illness',' severe stenosis in the mitral valve',62,1,1,120,80,100,200,0,0,0,0,1))